...
b0=Button(root,text="SINGLE PLAYER",font=("bold"),width=25,height=5,bg="gold",command=g)
b1=Button(root,text="DOUBLE PLAYER",font=("bold"),width=25,height=5,bg="gold",command=h)
