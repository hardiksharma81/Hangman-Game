...
def game():
   ...
   #function will display the no of entry box that is been guessed
    ...
    k=Button(leftframe,text="K",bg="Green",activebackground="blue",width="4",height="2",command=K)
    l=Button(leftframe,text="L",bg="Green",activebackground="blue",width="4",height="2",command=L)
    m=Button(leftframe,text="M",bg="Green",activebackground="blue",width="4",height="2",command=M)
    n=Button(leftframe,text="N",bg="Green",activebackground="blue",width="4",height="2",command=N)
    o=Button(leftframe,text="O",bg="Green",activebackground="blue",width="4",height="2",command=O)
    p=Button(leftframe,text="P",bg="Green",activebackground="blue",width="4",height="2",command=P)
    q=Button(leftframe,text="Q",bg="Green",activebackground="blue",width="4",height="2",command=Q)
    r=Button(leftframe,text="R",bg="Green",activebackground="blue",width="4",height="2",command=R)
    s=Button(leftframe,text="S",bg="Green",activebackground="blue",width="4",height="2",command=S)
